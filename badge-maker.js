...
const techStack = [
  ...
  { name: 'Swiper.js', color: 'blue', logoBase64: `data:image/svg+xml;base64,${Buffer.from(swiperSvg).toString('base64')}` },
...
techStack.forEach(tech => {
  const format = {
    ...
    color: tech.color,
    style: 'flat-square',
    logoBase64: tech.logoBase64 || (tech.icon ? `data:image/svg+xml;base64,${Buffer.from(tech.icon.svg).toString('base64')}` : undefined)
  };
